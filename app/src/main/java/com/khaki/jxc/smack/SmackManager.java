...
import com.khaki.jxc.bean.LoginResult;
...
public class SmackManager {
     ...
     * Xmpp服务器地址
     */
    public static final String SERVER_IP = Contants.SERVER_IP;
    /**
     * Xmpp 服务器端口
     */
    ...
    public LoginResult login(String username, String password) {
        ...
        try {
            ...
            user.setmNickname(getAccountName());
...
/*    public Chat createChat(String jid) {
    ...
    public RosterEntry getFriend(String user) {
        ...
        if (isConnected()) {
         /*   RosterEntry entry = Roster.getInstanceFor(mConnection).get(user);
            return entry;*/
        }
        throw new NullPointerException("服务器连接失败，请先连接服务器");
    }
...
/*
    ...
    public List<HostedRoom> getHostedRooms() throws Exception {
        ...
        return getMultiUserChatManager().getHostedRooms(mConnection.getServiceName());public*/
        return null;
    }
