...
public class AuctionListFragment extends Fragment {
    ...
    private com.khaki.jxc.client.Callbacks mCallbacks;
    ...
    public void onAttach(Context context) {
        ...
        if (!(context instanceof com.khaki.jxc.client.Callbacks)) {
            throw new IllegalStateException("AuctionListFragment所在的Context必须实现Callbacks接口!");
        }
        // 把该Activity当成Callbacks对象
        mCallbacks = (com.khaki.jxc.client.Callbacks) context;
    }
