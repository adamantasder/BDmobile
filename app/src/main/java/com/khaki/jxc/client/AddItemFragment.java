...
import com.khaki.jxc.client.util.HttpUtil;
...
public class AddItemFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        com.khaki.jxc.client.KindSpinnerAdapter adapter = new com.khaki.jxc.client.KindSpinnerAdapter(getActivity(), jsonArray, "kindName");
        // 显示物品种类列表
