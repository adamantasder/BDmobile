...
import com.khaki.jxc.utils.MathUtil;
...
import com.khaki.jxc.widge.CustomVideoView;
...
public class LoginActivity extends BaseActivity {
    ...
    protected void initData() {
        CharSequence userPhone = (CharSequence) SharedPrefUtil.getInstance().get(Contants.SP_LOGIN_USER_ID_KEY,"");
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    if (str.contains("登陆成功")) {
                        SharedPrefUtil.getInstance().put(Contants.SP_LOGIN_USER_ID_KEY, user);
                        ...
                        OkHttpUtil.loginSessionID = loginSessionID;
