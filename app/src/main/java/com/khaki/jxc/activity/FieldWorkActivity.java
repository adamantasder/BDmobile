...
import com.khaki.jxc.adapter.GridAdapter;
...
import com.khaki.jxc.utils.SoftHideKeyBoardUtil;
import com.khaki.jxc.utils.ToastUtils;
import com.khaki.jxc.utils.UserUntil;
import com.khaki.jxc.widge.TimePickerDialog;
...
public class FieldWorkActivity extends BaseActivity implements TimePickerDialog.TimePickerDialogInterface {
    ...
    protected void initView() {
        ...
        startdate = (SuperTextView) findViewById(R.id.vouchccode);
...
//            String msg = Contants.SERVER_IP + Contants.OfficeManage + Contants.queryOfficeThing + "?userPhone=" + UserUntil.gsonUser.getUserPhone();
    ...
    protected void initListener() {
        ...
        if (fieldworkType == Contants.FIELDWORK.OPEN_LEAVE) {
            final SuperTextView superTextView = leavetype.setOnSuperTextViewClickListener(new SuperTextView.OnSuperTextViewClickListener() {
                @Override
