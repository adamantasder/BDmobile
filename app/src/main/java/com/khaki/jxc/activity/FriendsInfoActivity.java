    ...
    protected void initListener() {
        ...
        videoToFriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FriendsInfoActivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        call.enqueue(new Callback<GsonUsers>() {
            ...
            public void onResponse(Call<GsonUsers> call, Response<GsonUsers> response) {
                ...
                if (gsonUsers.getCode() == 200) {
                    ...
                    userName = String.valueOf(user.getNickname());
...
//                            ImageUtils.setUserImageIcon(getApplicationContext(), userIcon, userName);
                    ...
                    friendName.setLeftBottomString(userName);
                    friendPhone.setLeftBottomString(userPhone);
                    friendEmail.setLeftBottomString(userEmail);
