 ...
 * 二维码扫描后的信息显示页面
 */
public class PU_vouchActivity extends AppCompatActivity {
    ...
    private Spinner spinnerBuy;
      private ArrayAdapter arr_adapter = null;
    private ArrayAdapter arr_adapterBuy = null;
    ...
    private String spinnerTextBuy;
    private String spinnerStr;

    public PU_vouchActivity() {
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vouch_items.setOnSuperTextViewClickListener(new SuperTextView.OnSuperTextViewClickListener() {
            ...
            public void onClickListener(ImageView imageView) {
                Toast.makeText(PU_vouchActivity.this, "添加请购成功", Toast.LENGTH_SHORT).show();
                //动态权限申请
                if (ContextCompat.checkSelfPermission(PU_vouchActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(PU_vouchActivity.this, new String[]{Manifest.permission.CAMERA}, 1);
                } else {
                    openQRCodeActivity();
                }
            }
...
// 获取全局变量用户Id
        ...
        btnSumbit.setOnClickListener(view -> {
            try {
                ...
                Retrofit retrofit = new Retrofit.Builder()
                        ...
                        .build();
                       appvouchIF pursBiz = retrofit.create(appvouchIF.class);//向服务器传值
                Call<ResponseBody> call = pursBiz.saveAppvouch(aa, bb, userId);
                ...
                call.enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        try {
                            ...
                            if (str.equals("1")) {
                                ...
                                DialogUtil.showDialog(PU_vouchActivity.this,
                                        "成功提交", true);
                            } else {
                                Log.e("POST传值", "失败");
                                DialogUtil.showDialog(PU_vouchActivity.this,
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable t) {
                        ...
                        DialogUtil.showDialog(PU_vouchActivity.this, "服务器响应异常，请稍后再试！", false);
                    }
                });
                   }
            } catch (Exception e) {
    ...
    public void openQRCodeActivity() {
        ...
        Intent intent = new Intent(PU_vouchActivity.this, CaptureActivity.class);
  ...
  protected void initData() {
    ...
    //获取当前时间
      ...
      //新订单号
      String url = OkHttpUtil.BASE_URL + "appvouchId";
      Log.i("url", "url " + url);
      //连接服务器
      String  result=null;
      try {
          ...
          ArrayList<AppVouch> pursList = gson.fromJson(jsonArray,
                  new TypeToken<ArrayList<AppVouch>>() {
                  }.getType());
          vouch_code.setRightString(pursList.get(0).getcCode());
           Id = pursList.get(0).getAppvouchid();
      } catch (Exception e) {
          e.printStackTrace();
      }
//厂库下拉框
        url = OkHttpUtil.BASE_URL + "vouchOr/"+userId;
      Log.i("url", "url " + url);
      //连接服务器
         result=null;
      try {
...
//审批类别下拉
        url = OkHttpUtil.BASE_URL + "purchaseType";
      Log.i("url", "url " + url);
      //连接服务器
         result=null;
      try {
          ...
          JsonParser parser = new JsonParser();
          JsonArray jsonArray = parser.parse(result).getAsJsonArray();
          ArrayList<PurchaseTypeVo> pursList = gson.fromJson(jsonArray,
                  new TypeToken<ArrayList<PurchaseTypeVo>>() {
                  }.getType());
          for(int i=0;i<pursList.size();i++) {
              Log.i("pursList", "pursList " + pursList.get(i).getcPTName());
              list1.add(pursList.get(i).getcPTName());
      ...
      spinnerBuy = (Spinner) findViewById(R.id.spinnerBuy);
      //适配器
      arr_adapter = new ArrayAdapter(this, R.layout.simple_spinner_item, list);
      arr_adapterBuy = new ArrayAdapter(this, R.layout.simple_spinner_item, list1);
      //设置样式
      arr_adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
      arr_adapterBuy.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

      //加载spinner适配器
      spinner.setAdapter(arr_adapter);
      spinnerBuy.setAdapter(arr_adapterBuy);
      //Spinner 选择数据监听事件
      ...
      //请购采买类型
      spinnerBuy.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {

          public void onItemSelected(AdapterView<?> arg0, View arg1,
                                     int arg2, long arg3) {
              //初始化不显示被选择的第一项
              arg1.setVisibility(View.INVISIBLE) ;
              spinnerTextBuy = arr_adapterBuy.getItem(arg2).toString();
              cBusType.setRightString(spinnerTextBuy);
          }
          public void onNothingSelected(AdapterView<?> arg0) {
              spinnerTextBuy = "";
              cBusType.setRightString(spinnerTextBuy);
    ...
    protected void initDatass(String  csysbarcode){
        ...
        for(int i=0; i<mInventories.size();i++){
        Log.i("mInventories", "mInventories " + mInventories.get(i).getcInvCode());}
        //   获取数据，向适配器传数据，绑定适配器
