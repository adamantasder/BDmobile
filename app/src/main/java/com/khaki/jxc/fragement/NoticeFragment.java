...
import com.khaki.jxc.activity.SelectGroupActivity;
import com.khaki.jxc.adapter.NoticeAdapter;
import com.khaki.jxc.client.R;
import com.khaki.jxc.gson.GsonNotice;
...
import com.khaki.jxc.retrofit.INoticeBiz;
...
import static com.khaki.jxc.Contants.REFLASH_NOTICE_FIRST;
import static com.khaki.jxc.Contants.REFLASH_NOTICE_MORE;
...
public class NoticeFragment extends Fragment implements View.OnClickListener {
    ...
    public void getNotices(int n, final int type) {
        ...
        call.enqueue(new Callback<GsonNotices>() {
            ...
            /*  1  if (response.body().getCode() == 200){
